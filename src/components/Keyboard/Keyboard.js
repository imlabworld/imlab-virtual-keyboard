  ...
  parseRowDOMContainers(
    ...
    if (rowDOMArray.length) {
      containerStartIndexes.forEach((startIndex, arrIndex) => {
         ...
         */
        const updatedStartIndex = startIndex - removedElements;
        const updatedEndIndex = endIndex - removedElements;
        ...
        const containedElements = rowDOMArray.splice(
          updatedStartIndex,
          updatedEndIndex - updatedStartIndex + 1,
        );
        removedElements = updatedEndIndex - updatedStartIndex;
         ...
         */
        rowDOMArray.splice(updatedStartIndex, 0, containerDOM);
